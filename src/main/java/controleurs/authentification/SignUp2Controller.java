...
public class SignUp2Controller implements Initializable {
    ...
    public void NextPage(ActionEvent event) throws IOException {
        ConnectController.user.getContacts().setCountFacebook(monFacebook.getText());
        ConnectController.user.getContacts().setCountGithub(monGithub.getText());
        ConnectController.user.getContacts().setCountLinkedln(monLinkedln.getText());
        ...
        if(monNumeroTelephone.getText()!=""&& validate!=1) {
            ConnectController.user.getContacts().setNbTelephone(Long.parseLong(monNumeroTelephone.getText()));
        }
